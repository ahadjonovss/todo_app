...
class AppTextStyles{
  ...
  static TextStyle headlineMediumBold (context,{Color? color,double? fontSize}) => TextStyle(fontFamily: "Rubik",fontWeight: FontWeight.w500,fontSize: fontSize??14.sp,color: color??AppColors.c554E8F);
