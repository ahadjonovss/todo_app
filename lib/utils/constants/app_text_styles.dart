...
class AppTextStyles{
  ...
  static TextStyle headlineMedium (context,{Color? color}) => TextStyle(fontFamily: "Rubik",fontWeight: FontWeight.w400,fontSize: 18.sp,color: color??AppColors.c554E8F);
